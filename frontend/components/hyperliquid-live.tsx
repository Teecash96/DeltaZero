      ...
      {error ? (
        ...
        <div className="hyperliquid-live-results">
          ...
          <section className="panel hyperliquid-upgrade">
            <div><span>x402 payment-protected</span><h2>Market context is free. Risk intelligence requires 0.5 USDT.</h2><p>Run hedge-drift verdicts, Safety Buffer scoring, funding stress testing, Monte Carlo sensitivity, and actionable operator recommendations through the DeltaZero Risk Engine.</p></div>
