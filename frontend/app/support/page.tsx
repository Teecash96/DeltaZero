  ...
  return (
    <div className="workspace evidence-page support-page">
      ...
      <section className="support-grid">
        <article className="panel"><span>Product support</span><h2>Ask DeltaZero</h2><p>Questions about Strategy Build, Wallet Auditor, Funding Stress Testing, Monte Carlo, or Agent Console.</p><a className="button button-secondary" href="https://x.com/DeltaZeroASP" target="_blank" rel="noreferrer">Message on X</a></article>
        ...
        <article className="panel"><span>Developer help</span><h2>Inspect the API</h2><p>Review live schemas, validation rules, response formats, and protected endpoints.</p><a className="button button-secondary" href="https://deltazero-production.up.railway.app/docs" target="_blank" rel="noreferrer">Open API docs</a></article>
      </section>
