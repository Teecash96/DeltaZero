  ...
  return (
    <div className="workspace evidence-page support-page">
      ...
      <section className="support-grid">
        <article className="panel"><span>Product support</span><h2>Ask DeltaZero</h2><p>Questions about Builder, Wallet Auditor, Stress Test, Monte Carlo, or Agent Console.</p><a className="button button-secondary" href="https://x.com/DeltaZeroASP" target="_blank" rel="noreferrer">Message on X</a></article>
