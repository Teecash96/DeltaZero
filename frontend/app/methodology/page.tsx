    ...
    <div className="workspace evidence-page">
      ...
      <section className="panel methodology-section">
        ...
        <div className="methodology-worked-example">
          ...
          <p>Premium tool calls are protected by the OKX x402 Agent Payments Protocol. Initialization, discovery, and methodology resources remain free; calculation tools require a 0.5 USDT settlement on X Layer.</p>
        </div>
        <div className="source-list">
